...
<div class="top-bar">
	<div class="container">
		<div class="action pull-right">
			<ul>
				<li class="login"><a
					href="http://211.63.89.140/meonggae_prj/logout.do"
					class="login-btn"> <i class="fa fa-sign-out"></i>로그아웃
				</a> / <a
					href="http://211.63.89.140/meonggae_prj/My/mypage/main/myPageMain_frm.do"
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-3">
				<div class="logo">
					<a href="http://211.63.89.140/meonggae_prj/index.do"> <img
			...
			<div class="col-md-3 col-sm-4">
				<div class="col-md-4 col-sm-4">
					<a href="http://211.63.89.140/meonggae_prj/product_page/product_add.do"
						class="icons"> <img
				...
				<div class="col-md-4 col-sm-4">
					<a href="http://211.63.89.140/meonggae_prj/My/store/store_frm.do?nick=${nick}"
						class="icons"> <img
